...
(\")                                                                                                                                        BEGIN(STRINGS);
// If we reach a string like \"EOF, this is a bad string
<STRINGS><<EOF>>                                                                                                                            return ERRORSTRING;
// Try to match a complete string text all the way to the ending \", match \\,\",\n,\r,\t,\0,\x separately
<STRINGS>([\x00-\x09\x0b-\x0c\x0e-\x21\x23-\x5b\x5d-\x7f]|(\\)(\\)|(\\)(\")|(\\)(n)|(\\)(r)|(\\)(t)|(\\)(0)|((\\)x[0-9|A-F][0-9|A-F]))*(\") {BEGIN(INITIAL); return STRING;}
// Try to match 1 or more instances of \" which indicate a string of the format "\" which is illegal
